             ...
             <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> <q>Далее детализация по товарной позиции</p>
                    <form class="forms-sample" method="post" action="/admin/product/view/<?php echo e($product->id); ?>" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="title"> Наименование товара</label> 
                        <div class="form-control" type="text" id="title" name="title" placeholder="Title" value="<?php echo e($product->title); ?>"> </div>
                      </div>
                      <div class="form-group">
                        <label for="price"> Цена товара</label> 
                        <div class="form-control" type="text" id="price" name="price" placeholder="price" value="<?php echo e($product->price); ?>"> </div>
                      </div>
                      <div class="form-group">
                        <label for="TextareaDescription"> Подробное описание товара</label>
                        <textarea class="form-control" id="description" rows="4" value="<?php echo e($product->description); ?>"></textarea>
                      </div>
                      <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\yaroslav.locv9\app\Views/admin/product_view.blade.php ENDPATH**/ ?>