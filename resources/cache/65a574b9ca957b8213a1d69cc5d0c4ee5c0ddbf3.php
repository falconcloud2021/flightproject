        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Полный каталог</a></li>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="#">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="price" placeholder="Price" value="<?php echo e($product->price); ?> грн."> 
                      </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OpenServer\domains\yaroslav.loc\app\Views/admin/product_unit.blade.php ENDPATH**/ ?>