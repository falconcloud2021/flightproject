<?php $__env->startSection('content'); ?>
	...
	<div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> Профайл администратора </h4>
                    <form class="form-sample">
                      <p class="card-description"> Персональная информация пользователя </p>
                      <div class="row">
                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\yaroslav.locv6\app\Views/admin/profile.blade.php ENDPATH**/ ?>