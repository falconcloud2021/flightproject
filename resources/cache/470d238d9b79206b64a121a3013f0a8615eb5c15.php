        ...
        <div class="s-12 m-12 l-4 margin-m-bottom-2x">
            ...
            <div class="line">
                ...
                <div class="s-11 m-11 l-11">
                    <p><a href="facebook.com" class="text-primary-hover"><b>Facebook</b></a></p>
                </div>
            </div>
        </div>
    ...
    <section class="padding background-dark">
        <div class="line">
            <div class="s-12 l-6">
                ...
                <p class="text-size-12">Все права защищены.</p>
            </div>
            <div class="s-12 l-6">
                <a class="right text-size-12" href="http://www.myresponsee.com" title="Responsee - lightweight responsive framework">Design and coding<br> by Zoo Studio</a>
            </div>
        </div>
    </section>
</footer>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\yaroslav.locv9\app\Views/admin/activity.blade.php ENDPATH**/ ?>