                      ...
                      <input type="text" class="form-control" name="first_name" value="<?php echo e($user->first_name); ?>"/> 
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="group_id" value="<?php echo e($user->group_id); ?>"/>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" name="img" value="<?php echo e($user->img); ?>" placeholder="ФОТО" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\yaroslav.locv8\app\Views/admin/profile.blade.php ENDPATH**/ ?>