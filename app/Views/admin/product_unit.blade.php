        ...
        <div class="content-wrapper">
            <div class="page-header">
             ...
             <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> Группа товара {{ $product->id }}</h4>
                    ...
                    <form class="forms-sample" method="post" action="#">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="created_at" placeholder="Created" value="{{ $product->created_at }}"> 
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" value="{{ $product->description }}"></textarea>
                      </div>
