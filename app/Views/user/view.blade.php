...
@section('content')
	...
	<div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> Добрый день <? echo ("$users->first_name"); ?></h4>
                    <form class="form-sample">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Ваше Отчество</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" />
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Основные категории</label>
                            <div class="col-sm-9">
                              <select class="form-control">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="membershipRadios" id="membershipRadios1" value="" checked> Первое </label>
                              </div>
                            </div>
                            <div class="col-sm-5">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="membershipRadios" id="membershipRadios2" value="option2"> Второе </label>
                              </div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <p class="card-description"> Адреса </p>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
